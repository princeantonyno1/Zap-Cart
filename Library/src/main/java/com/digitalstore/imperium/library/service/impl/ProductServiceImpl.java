...
import com.digitalstore.imperium.library.repository.ProductRepository;
...
import com.digitalstore.imperium.library.utils.ImageUpload;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product save(MultipartFile imageProduct, ProductDto productDto) {
        try {
            ...
            product.setFileLink(productDto.getFileLink());
...
//            product.setImage(productDto.getImage());
    ...
    public ProductDto getById(Long id) {
        ...
        productDto.setFileLink(product.getFileLink());
